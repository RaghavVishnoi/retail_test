class RequestMailer < ActionMailer::Base
  ...
  def csv_mail(email, file_name,subject)
    ...
    when 'approver@gionee.com'
      email = ['akash@gionee.co.in','dinesh.upadhyay@theradicles.com','jaipal.singh@gionee.co.in','aditya.bhargava@gionee.co.in']
    when 'superadmin@fosem.com'
      email = 'raghav.singh@lptpl.com'
    end
    mail(to: email,cc: 'raghav.singh@lptpl.com', subject: subject)
  end
