class ItemsController < ApplicationController
  ...
  private
    def item_params
      params.require(:item).permit(:name, :city_id, :item_region_id, :category_id, :subcategory_id, :short_description, :collection_id, :size_id, :alcohol_percent_id, :quantity, :unit_of_measurement, :image_ids => [], :prices => [:name, :value], :details => [:name, :value], :properties => [:field_id, :value, :values => []])
    end
