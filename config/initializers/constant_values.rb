...
LOCATION_OF_GSB = [
  ...
  SECURITY_ALARM_WORKING = [
    ["All three working","All three working"],
    ["Some working","Some working"],
    ["None working","None working"]
  ]

  DEMO_PHONES_INSTALLED = [
    ["3 Installed","3 Installed"],
  ...
  INSTALLATION_REPORT = [
    ["Installed","Installed"],
    ["Refusal to Install by retailer","Refusal to Install by retailer"],
    ["Site not suitable for installation","Site not suitable for installation"]
...
REQ_TYPE = ['gsb','sis','in_shop','maintenance','audit']
TYPE = [0,1,2,3,4]
STAT = ['pending','approved','declined','cmo_pending','cmo_declined']   
...
#ZED_SALES_URL = ['http://qa.zed-axis.com/zedaxisapi/service.svc/GetAllRetailerList?strUID=admin&strPwd=checkwcf&strReqKey=ZedSalesGioneeV2']
...
ROLE_ORDER = ['superadmin','approver','rrm','cmo','requester','vmqa','supervisor','auditor','vendor_allocator','vendor','downloader']
