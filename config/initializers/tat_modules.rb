MODULES = [
		"Request Generate-CMO Response",
		"CMO Response-RRM Response",
		"RRM Response-Vendor Allocator Response",
		"Vendor Allocator Response-Vendor Response",
		"Vendor Started-Vendor In Production",
		"Vendor In Production-Vendor In Transit",
