namespace :analytics do
  ...
  task :set_custom_db_config_paths do
    ...
    ENV['SCHEMA'] = 'db_analytics/schema.rb'
    Rails.application.config.paths['db'] = ['db_analytics']
    Rails.application.config.paths['db/migrate'] = ['db_analytics/migrate']
    Rails.application.config.paths['db/seeds'] = ['db_analytics/seeds.rb']
    Rails.application.config.paths['config/database'] = ['config/database_analytics.yml']
  end
